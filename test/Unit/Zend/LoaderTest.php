...
class Zend_LoaderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testLoaderInterfaceViaLoadClass()
    {
        try {
			...
			// changed by Michael Weibel <mweibel@hsr.ch> - We don't use Zend_Controller -> test another
			// interface
			Zend_Loader::loadClass('Zend_Db_Statement_Interface');
    ...
    public function testLoaderIsReadable()
    {
		...
		// changed by Michael Weibel <mweibel@hsr.ch> - as we don't use the Zend_Controller_Front, test for another Class.
		$this->assertTrue(Zend_Loader::isReadable('Zend/Db.php'), get_include_path());
    }
    ...
    public function testLoaderAutoloadLoadsValidClasses()
    {
        ...
        $this->error = null;
		// changed by Michael Weibel <mweibel@hsr.ch> - as we don't use Zend_Auth, just commented it
		// because the Zend_Db_Profiler_Exception already tests for this feature.
