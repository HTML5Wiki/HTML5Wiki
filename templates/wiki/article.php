<article id="content" class="grid_12 content article">
	<header class="title clearfix">
		...
		<ol class="capsulebar">
			...
			<li class="item last history"><a href="#" onclick="Article.loadArticleHistory( <?php echo $this->wikiPage->id; ?> );" class="capsule"><span class="caption">&Auml;nderungsgeschichte</span></a></li>
		</ol>
	</header>
	<section>
